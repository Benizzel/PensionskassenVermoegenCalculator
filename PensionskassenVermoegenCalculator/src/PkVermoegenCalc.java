...
public class PkVermoegenCalc {	
	...
	/** 
	*@return:Summe der j�hrlichen Pensionkasseneinzahlungen (=Pensionskassenverm�gen) basierend auf dem koordinierten Lohn
	*Annahme: Keine detailierten PK Daten eingegeben. Es wird angenommen, dass das Einkommen �ber alle Jahre das gleiche ist und nur der obligatorische Teil einbezahlt wird
	*Unter 25 gibt es keine PK Einzahlung, Anschliessend �ndert sich der Beitrag alle 10 Jahre
	*/
	...
	public int calculateTheoretischesPensionskassenVermoegen(boolean istWeiblich, int einkommen) {
		...
		//a = theoretisches Alter f�r Berechnung
